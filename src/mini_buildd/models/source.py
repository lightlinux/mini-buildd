...
codeversion is only used for base sources.""")
    ...
    class Admin(mini_buildd.models.base.StatusModel.Admin):
        ...
        def mbd_meta_add_debian(cls, msglog):
            ...
            """
            keys = {
                "archive_buster": "DC30D7C23CBBABEE",            # Debian Archive Automatic Signing Key (10/buster) <ftpmaster@debian.org>
                "release_buster": "DCC9EFBF77E11517",            # Debian Stable Release Key (10/buster) <debian-release@lists.debian.org>
            ...
            cls._mbd_get_or_create(msglog, "Debian Backports", "stretch-backports-sloppy",
                                   [keys["archive_jessie"], keys["archive_stretch"]])
            ...
            cls._mbd_get_or_create(msglog, "Debian", "bullseye",
                                   [keys["archive_stretch"], keys["archive_buster"]])
            cls._mbd_get_or_create(msglog, "Debian", "bullseye-security",
                                   [keys["security_archive_stretch"], keys["security_archive_buster"]],
                                   extra_options="X-Remove-From-Component: updates/")
